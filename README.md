# NASA-TLX Dataset of UTA7

<img src="https://github.com/MIMBCD-UI/meta/blob/master/banners/datasets_1280x640.png?raw=true" width="100%" />

[![MIT](https://flat.badgen.net/github/license/MIMBCD-UI/dataset-uta7-nasa-tlx)](https://github.com/MIMBCD-UI/dataset-uta7-nasa-tlx/blob/master/LICENSE)
...
[![HitCount](http://hits.dwyl.io/MIMBCD-UI/dataset-uta7-nasa-tlx.svg)](http://hits.dwyl.io/MIMBCD-UI/dataset-uta7-nasa-tlx)
...
```
git clone git@github.com:MIMBCD-UI/dataset-uta7-nasa-tlx.git
```

1.2. Go inside the project folder:

```
cd dataset-uta7-nasa-tlx/
```
...
For more information about the [MIMBCD-UI](https://MIMBCD-UI.github.io/) project just follow the [link](https://github.com/MIMBCD-UI/meta). Pieces of information about details of this *dataset* are also in a [wiki](https://github.com/MIMBCD-UI/dataset-uta7-nasa-tlx/wiki).
